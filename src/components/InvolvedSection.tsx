...
const GetInvolvedSection: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-black lg:py-16 py-6 lg:mt-36 mt-12 px-3">
      <h2 className="text-center bg-white text-black lg:text-lg lg:px-5 px-2 py-3 mb-4">
        GET INVOLVED WITH KALP FOUNDATION
      </h2>
      <p className="text-white  text-center lg:text-md text-sm mb-12 lg:px-40 px-2">
  ...
  <div ref={box1}  className="bg-[#191919] text-white lg:text-xl border border-[#191919] hover:border hover:border-white/30 text-xl text-center py-16 px-5 w-56 transition-all duration-100 ease-in-out">
    Engage with the Community
  </div>
  <div className="bg-[#191919] h-[28px] w-[7px] lg:w-[28px] lg:h-[7px]"></div>
  <div ref={box2}  className="bg-[#191919] text-white lg:text-xl border border-[#191919] hover:border hover:border-white/30 text-xl text-center py-16 px-8 w-56 transition-all duration-100 ease-in-out">
    Contribute to Development
  </div>
  <div className="bg-[#191919] h-[28px] w-[7px] lg:w-[28px] lg:h-[7px]"></div>
  
  <div ref={box3}  className="bg-[#191919] text-white lg:text-xl border border-[#191919] hover:border hover:border-white/30 text-xl text-center py-16 px-8 w-56 transition-all duration-100 ease-in-out">
    Spread the Word
  </div>
</div>
